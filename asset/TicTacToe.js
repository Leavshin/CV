 ...
 if (computer) {
   ...
   if (player == human) {
    ...
    if (player == player1) {
      ...
      drawTheWinnersLine(board);  
      setTimeout(function() {
      winner.innerHTML ="<h1>Joueur 1 gagne !</h1>";
        }, 1000);
      return;
      } 
    }  else {
      if (checkWin(board, player)) {
         ...
         drawTheWinnersLine(board);  
         setTimeout(function() {
         winner.innerHTML ="<h1>Joueur 2 gagne !</h1>";
        }, 1000);
      return;
      } 
  ...
  if (checkBoard(board)) {
     //  console.log(cb); 
      setTimeout(function() {
       winner.innerHTML= "<h1>Egalité</h1>";
       //reset();
      }, 1000);
      return;
   }
